...
class C(BaseConstants):
    NAME_IN_URL = 'VideoChoice_PressureJ'
...
page_sequence = [Part2_Instruction_Page, VideoChoice, Part3_Intro, Video_alert, Part3_Video, Part3_Video2, OptionChoice, Justification, Explanation, Hypo_choiceq, Guesses, Emotions, Anticipationq, Attention1,Attention2, FailedAttention, EQ, Feedback, Back]
