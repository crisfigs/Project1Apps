...
class Player(BasePlayer):
   ...
   # q3 = models.IntegerField(label="3. Please state whether the following is True or False: 'You can choose between options A and B either Before watching the video or After watching the video'",
    ...
    pressureStC_ant = models.IntegerField(label="3. To what extent did you anticipate pressure to donate to Save the Children generated by the Save the Children video?", blank=True)
    pressureGrass_ant = models.IntegerField(label="4. To what extent did you anticipate pressure to donate to Save the Children generated by the alternative video?", blank=True)

    openq = models.LongStringField(label="2. Explain in the space below other thoughts and feelings associated to watching the video (this is a required question).")
...
class Openq(Page):
    form_model = 'player'
    form_fields = ['openq','emotions_ant','pressureStC_ant', 'pressureGrass_ant']
