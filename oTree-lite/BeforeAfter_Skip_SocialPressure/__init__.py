...
class Player(BasePlayer):
   ...
   # q3 = models.IntegerField(label="3. Please state whether the following is True or False: 'You can choose between options A and B either Before watching the video or After watching the video'",
    ...
    pressureStC_ant = models.IntegerField(label="3. To what extent did you anticipate pressure to donate (choose option B) generated by the request video from Save the Children?")
    pressureGrass_ant = models.IntegerField(label="4. To what extent did you anticipate pressure to donate (choose option B) generated by the alternative video?")
